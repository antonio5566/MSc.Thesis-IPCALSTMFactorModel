...
load (['Empirical_Result/macrofactor/' dataname '_K' num2str(K) '_puremacro'])


%%
clearvars -except R K Z X XFITS_GBGD GammaBeta Factor W mf Nts T GBGD_F GBGD_GB GBGD_GD collect XFITS_GB
