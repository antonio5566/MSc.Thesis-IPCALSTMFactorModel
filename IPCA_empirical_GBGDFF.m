...
for K=1:6 %change here
    clearvars -except K
FFchoices = {'FF_1' 'FF_2' 'FF_3' 'FF_4' 'FF_5' 'FF_6'};
...
%% FF models
ffdata = load('F-F_Research_Data_5_Factors_2x3_plusMOM');
...
%% Save results
save(['Empirical_result/results_GBGDFF/Results_GBGDFF_' dataname '_K' num2str(K) '_' FFchoice] ...
    , 'xret' , 'W' , 'date' , 'LOC' , 'Nts' ...
    , 'Gamma*' , 'Factor*' , 'Lambda*' ...
    , 'R*' ...
    , 'Q*' ...
