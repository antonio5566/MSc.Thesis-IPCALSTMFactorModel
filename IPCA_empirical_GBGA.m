% mkdir Empirical_result/results_GBGA
...
save(['Empirical_result/results_GBGA/''Results_GBGA_' dataname '_K' num2str(K)] ...
    , 'xret' , 'W' , 'date' , 'LOC' , 'Nts' ...
    , 'R*' ...
    , 'X*' ...
    , 'GBGA_*' , 'GB_*' ...
...
disp('RR2_total_GB RR2_total_GBGA RR2_pred_GB RR2_pred_GBGA')
